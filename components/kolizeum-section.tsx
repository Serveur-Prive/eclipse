  ...
  return (
    <div className="max-w-6xl mx-auto relative z-10">
      <div className="relative mb-12">
        <div className="bg-gradient-to-r from-black/80 to-primary/30 backdrop-blur-sm border border-primary/30 rounded-xl p-6 flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="w-full md:w-2/3 text-center md:text-left">
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4 mb-6">
              <div className="bg-black/50 border border-primary/30 rounded-lg px-4 py-2 flex items-center">
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-4 mb-6">
                {topPlayers.map((player, index) => (
                  <div key={player.id} className="bg-black/70 border border-primary/20 rounded-lg p-4">
              ...
              <Link href="/classement">
                <Button variant="outline" className="border-primary/30 text-white hover:bg-red-900/20 w-full">
