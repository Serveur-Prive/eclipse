                ...
                <Card className="bg-gradient-to-r from-black/70 to-red-950/30 backdrop-blur-sm border-red-800/30 overflow-hidden">
                  <CardContent className="p-6">
                    <div className="flex items-center mb-4">
                      <div className="bg-red-600 rounded-full w-8 h-8 flex items-center justify-center mr-3">
              ...
              >
                <Card className="bg-gradient-to-r from-black/70 to-red-950/30 backdrop-blur-sm border-red-800/30 overflow-hidden">
                  <CardContent className="p-6">
                    ...
                    <p className="text-white/70 mb-6 pl-11">
                      Téléchargez notre lanceur personnalisé pour accéder facilement au serveur Dofus Eraziel.
                    </p>
